const JASS_TYPES = ['Eichle', 'Rose', 'Schelle', 'Schilte', 'Slalom ⛷', 'Uneufe ⬆', 'Obeabe ⬇', 'Gusti 🐈', 'Wunsch ❔'];
...
function renderJassOptions() {
    ...
    JASS_TYPES.forEach(game => {
        ...
        if (['Eichle', 'Rose', 'Schelle', 'Schilte'].includes(game)) {
            displayText = `<img src="img/${game}.png" alt="${game}" class="jass-icon">`;
        }
...
function renderGamesTable() {
    ...
    selectedGames.forEach((game, index) => {
        ...
        let displayText = game;
        if (['Eichle', 'Rose', 'Schelle', 'Schilte'].includes(game)) {
            displayText = `<img src="img/${game}.png" alt="${game}" class="jass-icon-table">`;
        }
